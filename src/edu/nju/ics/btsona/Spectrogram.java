...
public class Spectrogram{
         ...
         * @param wave
         */
        public Spectrogram(double[] amplitudes) {
        		this.isWave = false;
        ...
        private void buildSpectrogram(){
                ...
                System.out.println(numSamples + ":" + fftSampleSize);
                if(this.isWave)
                	framesPerSecond=(int)(numFrames/wave.length()); 
                else
                	framesPerSecond=(int)(numFrames/amplitudes.length); 
                ...
                if (absoluteSpectrogram.length>0){
                        ...
                        if(this.isWave)
                        	...
                        	unitFrequency=8000/2/numFrequencyUnit;  // frequency could be caught within the half of nSamples according to Nyquist theory
